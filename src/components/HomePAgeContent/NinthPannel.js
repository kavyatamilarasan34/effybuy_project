        ...
        <div className="block-style-eighteen mt-90 pt-50 md-mt-80">
         <div className="text-wrapper">
            <h3 className="title" style={{"textAlign":"center"}}>
                Join our webinar to discover <br></br> <span> How Effybuy helps you </span>
            </h3><br></br>
            <br></br>
          </div>
              ...
              >
                  ...
                  <ul>
                      ...
                      <li style={{"position":"relative","color":"#999","margin":"10px"}}>
                        <img src={cross} alt="k" style={{"position":"absolute","left":"-30px","top":"-2px"}} /> Inconsistent pricing from manual negotiations 
                      </li>
                      <li style={{"position":"relative","color":"#999","margin":"10px"}}>
                        <img src={cross} alt="k" style={{"position":"absolute","left":"-30px","top":"-2px"}} /> Missed savings due to lack of market benchmarks
                      </li>
                      <li style={{"position":"relative","color":"#999","margin":"10px"}}>
                        <img src={cross} alt="k" style={{"position":"absolute","left":"-30px","top":"-2px"}} /> Time-consuming back-and-forth with suppliers
                      </li>
                      <li style={{"position":"relative","color":"#999","margin":"10px"}}>
                        <img src={cross} alt="k" style={{"position":"absolute","left":"-30px","top":"-2px"}} />  Strained partnerships from constant barganing
                      </li>
                  </ul>
                  </div>
                </div>
